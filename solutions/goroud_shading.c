...
int gou(int x[], int y[]){
	if(y[0]<y[1]) lc(x[0], x[1], y[0], y[1]);
	else lc(x[1], x[0], y[1], y[0]);
	if(y[2]<y[1]) lc(x[2], x[1], y[2], y[1]);
	else lc(x[1], x[2], y[1], y[2]);
	if(y[0]<y[2]) lc(x[0], x[2], y[0], y[2]);
	else lc(x[2], x[0], y[2], y[0]);
